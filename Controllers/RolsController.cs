...
namespace Ikigenda.Controllers
{
    public class RolsController : Controller
    {
        ...
        public RolsController(AgendaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RolIdd,Nombre")] Rol rol)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RolIdd,Nombre")] Rol rol)
        {
            if (id != rol.RolId)
            {
                return NotFound();
